...
function Mission() {
  return (
    <div className="lg:h-[58rem] bg-gray-200">
      <div className="md:pl-8 md:pr-2 h-5/6 grid  lg:grid-cols-2 grid-cols-1 grid-rows-2  mt-5 lg:grid-rows-1 justify-between px-5 gap-40 items-center pb-20 pt-20 pt-40">
      <div className="lg:h-4/6 w-5/6  relative w-1/2 flex md:w-1/2">
